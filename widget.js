 ...
 * Paste the following ONE line into your WordPress footer (Appearance → Theme Editor → footer.php,
 * just before </body>) — replace YOUR_VERCEL_URL with your actual Vercel deployment URL:
 *
...
(function () {
  ...
  // ── State ─────────────────────────────────────────────────────────────────
  const messages  = [];   // full conversation history sent to API
  let   isOpen    = false;
  let   isWaiting = false;
  let   greeted   = false;
